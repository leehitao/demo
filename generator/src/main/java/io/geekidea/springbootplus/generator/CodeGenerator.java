...
public class CodeGenerator {
    ...
    public void init(String tableName, GeneratorProperties generatorProperties) {
        ...
        if (StringUtils.isBlank(parentPackage)) {
            throw new BizException("项目父包不能为空");
        }
        // 如果包路径为空，转换包名称路径
        ...
        if (StringUtils.isBlank(mavenModuleName)) {
            throw new BizException("mavenModuleName不能为空");
        }
        if (StringUtils.isBlank(tableName)) {
            throw new BizException("tableName不能为空");
        }
    ...
    public void generator(String tableName, String pkIdName, GeneratorProperties generatorProperties) {
        ...
        if (mybatisPlusGeneratorConfig == null) {
            throw new BizException("mybatisPlusGeneratorConfig不能为空");
        }

        // 全局配置
        GlobalConfig globalConfig = mybatisPlusGeneratorConfig.getGlobalConfig();
        if (globalConfig == null) {
            throw new BizException("globalConfig不能为空");
        }
        ...
        if (dataSourceConfig == null) {
            throw new BizException("dataSourceConfig不能为空");
        }
        ...
        if (strategyConfig == null) {
            throw new BizException("strategyConfig不能为空");
        }
        // 设置生成的表
        ...
        InjectionConfig injectionConfig = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                if (CollectionUtils.isEmpty(tableInfos)) {
                    throw new BizException(tableName + "表不存在");
                }
